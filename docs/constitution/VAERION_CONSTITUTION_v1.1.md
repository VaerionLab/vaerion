# VAERION CONSTITUTION — v1.1

| | |
|---|---|
| **Document** | VAERION_CONSTITUTION_v1.1 — the ratified law of the Vaerion engine |
...
| **Supersedes** | v1.0 (retained unmodified at `VAERION_CONSTITUTION_v1.0.md` as historical record) |
...
| D-M′ | Command surface law *(supersedes D-M "Daily Seven")* | The CLI command surface grows only by ratified Founder directive, and every command honors the Five Guarantees (D-N). The surface of record is `vae --help` — help and dispatch never disagree. The ratified surface at v1.1: `init, run, resume, explain, journal, doctor, dev, serve, package, provenance, repo, ci, release`. (Supersession rationale in §11-A1.) |
