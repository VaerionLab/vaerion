# VAERION CONSTITUTION — v1.4

| | |
|---|---|
| **Document** | VAERION_CONSTITUTION_v1.4 — the ratified law of the Vaerion engine |
...
| **Supersedes** | v1.3 (retained unmodified at `VAERION_CONSTITUTION_v1.3.md` as historical record); v1.2 (retained unmodified at `VAERION_CONSTITUTION_v1.2.md`); v1.1 (retained unmodified at `VAERION_CONSTITUTION_v1.1.md`); v1.0 (retained unmodified at `VAERION_CONSTITUTION_v1.0.md`) |
...
Status of record (reconciled against the repository at the v1.1 amendment; GA
campaign note added at v1.4): MS-0 through MS-5 **complete**; MS-6 **in
progress** (reproducible bundles, distribution packaging, CI pipeline, beta docs
shipped; native installers, performance double-check, accessibility sweep
remain); GA pending. The remaining MS-6 close-out and GA preparation are
executed as ONE ratified engineering campaign — Phases 7–10 (§11-A4): the
performance double-check becomes a permanent budget gate, the accessibility
sweep becomes a measured audit, the release train is rehearsed end-to-end, and
the GA gate archives the burndown and GO/NO-GO evidence.
...
| 10 | ASCENSION XVIII | ▶ in flight | ratified under A4 — the GA gate (burndown ledger + GO/NO-GO dossier + §7 reconciliation at the boundary; program close: version lockstep, tag, artifact trust chain, canonical + GitHub synchronization) |
