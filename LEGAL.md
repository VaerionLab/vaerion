...
| Source repository | `https://github.com/VaerionLab/vaerion` | the only source of truth; mirrors are derived |
...
- The GitHub repository `VaerionLab/vaerion` lives under the Founder-controlled organization **VaerionLab**; administrative authority over the repository, its releases, secrets, and settings rests with the Founder (migration of record: Phase 13, Task ID 15 — the repository's prior location was `falconxa0-commits/vaerion`).
